...
│   ├── FRONTEND-INTEGRATION-SUMMARY.txt
...
│   ├── GETTING-STARTED.md
│   └── README.md
└── ipv6-docker-setup/          - IPv6 documentation
    ├── README.md
    └── ENABLE-IPv6-NOW.md
```
...
**...login to the app**
→ [Login Credentials](setup/LOGIN-CREDENTIALS.md)

**...set up Stripe payments**
→ [Stripe Setup](setup/STRIPE-SETUP.md)
...
**...use IPv6**
→ [Enable IPv6 NOW](ipv6-docker-setup/ENABLE-IPv6-NOW.md)

**...understand authentication**
→ [Authentication Setup](setup/AUTHENTICATION-SETUP.md)

**...see what was built in this session**
→ [Session Summary](summaries/SESSION-COMPLETE-SUMMARY.md)
